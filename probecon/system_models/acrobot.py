...
class Acrobot(SymbtoolsEnv):
    """
    Class that implements an acrobot environment
    ...
    def __init__(self,
        ...
        super(Acrobot, self).__init__(mod_file, self.p, time_step,
    ...
    def render(self, mode='human'):
        ...
        # determin new position of the torque arrow
        translation = self.pole1trans.translation
        newx = -pole1len*np.sin(th1) + translation[0]
        newy = pole1len*np.cos(th1) + translation[1]
        # move torque arrow to the new position of the pole tip
        self.circle_trans.set_translation(newx, newy)
        self.arrow_trans.set_translation(newx, newy)
